...
func (*Consignment) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_b9eb92b9f315dd51, []int{0}
}
...
func (*Container) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_b9eb92b9f315dd51, []int{1}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_b9eb92b9f315dd51, []int{2}
}
...
func (*GetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_b9eb92b9f315dd51, []int{3}
}
...
func init() {
	proto.RegisterFile("proto/consignment/consignment.proto", fileDescriptor_consignment_b9eb92b9f315dd51)
}

var fileDescriptor_consignment_b9eb92b9f315dd51 = []byte{
